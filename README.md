...
managementClient.CreateUser(createUserReqDto)
...
managementClient.UpdateUser ( updateUserReqDto)
...
managementClient.GetUser(id,username,email,phone,email,externalId);
...
managementClient.DeleteUsersBatch (deleteUsersBatchDto);
...
- [SDK 文档](https://docs.authing.cn/v2/reference-new/sdk-v5/csharp/install.html)
