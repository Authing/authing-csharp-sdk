...
{
    /// <summary>
    /// CreateFunctionModelFieldDto 的模型
    /// </summary>
    public partial class CreateFunctionModelFieldDto
    {
        /// <summary>
...
/// 
        ...
        public Condition  RelationOptionalRange {get;set;}
        /// <summary>
        ///  关联数据要展示的属性
        /// </summary>
...
/// 
        ...
        public DropDownItemDto  DropDown {get;set;}
        /// <summary>
        ///  前端格式化显示规则:
        /// </summary>
        [JsonProperty("format")]
...
/// 
        ...
        public enum type
        {
            ...
            RELATION,
            [EnumMember(Value="ReverseRelation")]
            REVERSE_RELATION,
