...
/// 
    ...
    public SignInByPasswordPayloadDto  PasswordPayload {get;set;}
    /// <summary>
    ///  当认证方式为 `PASSCODE` 时此参数必填
    /// </summary>
    [JsonProperty("passCodePayload")]
    public SignInByPassCodePayloadDto  PassCodePayload {get;set;}
    /// <summary>
    ///  当认证方式为 `AD` 时此参数必填
    /// </summary>
    [JsonProperty("adPayload")]
    public SignInByAdPayloadDto  AdPayload {get;set;}
    /// <summary>
    ///  当认证方式为 `LDAP` 时此参数必填
    /// </summary>
    [JsonProperty("ldapPayload")]
    public SignInByLdapPayloadDto  LdapPayload {get;set;}
    /// <summary>
    ///  可选参数
    /// </summary>
