...
namespace Authing.CSharp.SDK.Models.Authentication
{
    ...
    public class SendEnrollFactorRequestDto
    {
        ...
        public SendEnrollFactorProfileDto Profile { get; set; }
    }

    public class SendEnrollFactorProfileDto
    {
        /// <summary>
        ...
        /// <summary>
        /// 当发起绑定手机短信认证要素且需要绑定国际手机号时可以设置，默认为 +86，中国大陆手机区号。Authing 短信服务暂不内置支持国际手机号，
